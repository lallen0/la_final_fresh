...
maggie_daley_location_id = Location.find_by(description: "Maggie Daley").id
riverside_gym_location_id = Location.find_by(description: "Riverside Gym").id
the_park_location_id = Location.find_by(description: "The Park").id

courts_data = [
  { location_id: maggie_daley_location_id },
  { location_id: maggie_daley_location_id },
  { location_id: riverside_gym_location_id },
  { location_id: riverside_gym_location_id },
  { location_id: the_park_location_id},
  { location_id: the_park_location_id },
  { location_id: the_park_location_id },
  { location_id: the_park_location_id }
# Add more user data as needed
